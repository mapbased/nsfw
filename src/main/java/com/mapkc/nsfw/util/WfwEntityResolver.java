...
public class WfwEntityResolver implements EntityResolver {
    ...
    public InputSource resolveEntity(String publicId, String systemId)
        ...
        File localfile = new File(BASE_LOCATION, u.getHost() + "/"
                + u.getPath());

        if (localfile.exists()) {
            InputSource is = new InputSource(new java.io.BufferedInputStream(
            ...
            return new InputSource(new java.io.ByteArrayInputStream(
                    this.download(u, localfile)));
        }

    }

    private synchronized byte[] download(java.net.URL u, File localfile)
            throws IOException {
    ...
    private void readUrl(java.net.URL u, java.io.ByteArrayOutputStream bos)
            throws IOException {
